/*
Default C++ Copy Policy
~~~~~~~~~~~~~~~~~~~~~~~~~~

This triggers:

*** Error in `./a.out': double free or corruption (fasttop): 0x0000000001fcac20 ***

as the standard C++ copy behaviour (shallow copy) for assignment and
